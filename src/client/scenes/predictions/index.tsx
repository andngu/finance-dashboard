      ...
      <DashboardBox width="100%" height="100%" p="1rem" overflow="hidden">
         ...
         <ResponsiveContainer width="100%" height="100%">
            ...
            >
               ...
               <YAxis domain={[12000, 26000]} axisLine={{ strokeWidth: "0" }} tickFormatter={(v) => `$${v}`} tickLine={false} style={{ fontSize: "10px" }}>
               ...
               {isPredictions && <Line type="monotone" dataKey="Predicted Revenue" stroke={palette.secondary[500]} />}
            </LineChart>
         </ResponsiveContainer>
      </DashboardBox>
   );
